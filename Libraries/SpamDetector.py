...
import numpy as np
from sklearn.pipeline import Pipeline # To hold different models 
from termcolor import colored # This colorizes the output text.
...
class SpamDetector:
    def __load_data__():
        # TODO: KR: Need to retrieve it from database.
        # TODO: KR: Need to build pipelines to get data from varioud source to this data store
    ...
    def __extract_transform_load__(df):
